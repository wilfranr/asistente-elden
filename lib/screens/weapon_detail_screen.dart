...
class WeaponDetailScreen extends StatelessWidget {
  ...
  Widget _buildStatsSection(String title, List<WeaponStat> stats, IconData icon, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildStatRow(WeaponStat stat, Color color) {
    final String displayName = _getStatDisplayName(stat.name);
    final double percentage = stat.amount / 150.0; // Normalizamos a 150 como máximo típico
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: weapon.scalesWith.isNotEmpty
              ? Wrap(
                  spacing: 12,
                  runSpacing: 8,
                  children: weapon.scalesWith.map((scaling) => _buildScalingChip(scaling)).toList(),
                )
              : const Center(
                  child: Text(
  ...
  Widget _buildScalingChip(WeaponScaling scaling) {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: weapon.requiredAttributes.isNotEmpty
              ? Wrap(
                  spacing: 12,
                  runSpacing: 8,
                  children: weapon.requiredAttributes
  ...
  Widget _buildRequirementChip(WeaponStat requirement) {
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                '${weapon.weight!.toStringAsFixed(1)} unidades',
                style: const TextStyle(
                  color: AppTheme.textColor,
                  fontSize: 16,
                ),
